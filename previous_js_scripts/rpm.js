...
*    @property {string} [RPM.FILE_SCRIPTS = RPM.PATH_DATAS + "scripts" + RPM.EXTENSION_JSON]
...
*    @property {string} [RPM.PATH_SCRIPTS = RPM.PATH_DATAS + "Scripts/"]
*    @property {string} [RPM.PATH_PLUGINS = RPM.PATH_SCRIPTS + "Plugins/"]
*    @property {string} [RPM.PATH_SYSTEM = RPM.PATH_SCRIPTS + "System/"]
...
class RPM
{
    ...
    static FILE_SCRIPTS = RPM.PATH_DATAS + "scripts" + RPM.EXTENSION_JSON;
    ...
    static PATH_SCRIPTS = RPM.PATH_DATAS + "Scripts/";
    static PATH_PLUGINS = RPM.PATH_SCRIPTS + "Plugins/";
    static PATH_SYSTEM = RPM.PATH_SCRIPTS + "System/";
    static PATH_SHADERS = RPM.PATH_SYSTEM + "shaders/";
