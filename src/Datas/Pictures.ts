...
class Pictures
{
    ...
    static async read() {
        ...
        let k: number, j: number, m: number, n: number, id: number, jsonHash: 
            Record<string, any>, jsonList: Record<string, any>[], jsonPicture: 
            Record<string, any>, list: System.Picture[], picture: System.Picture;
        for (let i = 0; i < l; i++) {
            jsonHash = json[i];
            k = jsonHash.k;
            jsonList = jsonHash.v;
