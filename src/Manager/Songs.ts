...
class Songs {
	...
	public static keepAliveStarted = false;
	public static musicEffectPausedHowl: typeof Howl | null = null;
	 ...
	 *  @param {number} end - The end of the song
	 */
	static initializeProgressionMusic(i: number, f: number, equation: number, end: number) {
