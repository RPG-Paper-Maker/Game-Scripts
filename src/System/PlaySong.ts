...
class PlaySong extends Base {
	...
	read(json: Record<string, any>) {
		...
		this.songID = json.isbi ? new System.DynamicValue(json.vid) : System.DynamicValue.createNumber(json.id);
		this.volume = new System.DynamicValue(json.v);
		this.isStart = json.is;
		this.start = this.isStart ? new System.DynamicValue(json.s) : System.DynamicValue.createNumber(0);
		this.isEnd = json.ie;
		this.end = this.isEnd ? new System.DynamicValue(json.e) : System.DynamicValue.createNumber(0);
	}
