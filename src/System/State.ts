...
class State extends Base {
    ...
    public speedID = RPM.defaultValue(json.s, 1);
    public frequencyID = RPM.defaultValue(json.f, 1);
    public moveAnimation = json.move;
    public stopAnimation = json.stop;
    public climbAnimation = json.climb;
    public directionFix = json.dir;
    public through = json.through;
    public setWithCamera = json.cam;
    public pixelOffset = json.pix;
    public keepPosition = json.pos;
    public detection = RPM.defaultValue(json.ecd, null);
    if (public detection !== null)
    {
        public detection = EventCommand.getEventCommand(this.detection);
    }
