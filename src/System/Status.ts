...
class Status extends Icon {
	...
	read(json: Record<string, any>) {
		...
		this.chanceReleaseAfterAttacked = System.DynamicValue.readOrDefaultNumberDouble(
			json.chanceReleaseAfterAttacked
		);
		...
		Utils.readJSONSystemList({
			...
			cons: System.StatusReleaseTurn,
		});
		this.messageAllyAffected = System.DynamicValue.readOrDefaultMessage(json.messageAllyAffected);
		this.messageEnemyAffected = System.DynamicValue.readOrDefaultMessage(json.messageEnemyAffected);
		this.messageStatusHealed = System.DynamicValue.readOrDefaultMessage(json.messageStatusHealed);
		this.messageStatusStillAffected = System.DynamicValue.readOrDefaultMessage(json.messageStatusStillAffected);
		this.effects = [];
		Utils.readJSONSystemList({
