	...
	draw(x: number, y: number, w: number, h: number) {
		...
		if (this.pictureBar && this.pictureBar.picture)
		{
			...
			this.pictureBar.picture.draw(
			{
				...
				sw: Math.ceil(((this.pictureBar.picture.oW / 2) - (this.pictureBar.borderLeft + this.pictureBar.borderRight)) * percent),
				w: Math.ceil(((this.pictureBar.picture.oW / 2) - (this.pictureBar.borderLeft + this.pictureBar.borderRight)) * percent),
				h: this.pictureBar.picture.h
			});
		...
		this.graphicValue.draw(x + ScreenResolution.getScreenX(this.maxStatNamesLength) + 10, y, 0, 0);
	}
}
