					...
					if (this.isBuy()) {
						if (graphic.item.shop.isPossiblePrice()) {
							...
							if (
								...
								(<Graphic.UseSkillItem>this.windowBoxUseItem.content).hideArrow = false;
								(<Graphic.UseSkillItem>this.windowBoxUseItem.content).indexArrow = 0;
								(<Graphic.UseSkillItem>this.windowBoxUseItem.content).setSkillItem(graphic.item.system);
