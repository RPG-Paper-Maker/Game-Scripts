...
class KeyboardAssign extends Base {
	...
	async load() {
		...
		// Creating windows
		this.windowKeyboard = new WindowBox(
		...
		this.windowPress = new WindowBox(
			ScreenResolution.SCREEN_X / 2 - Scene.KeyboardAssign.WINDOW_PRESS_WIDTH / 2,
			ScreenResolution.SCREEN_Y / 2 - Scene.KeyboardAssign.WINDOW_PRESS_HEIGHT / 2,
			Scene.KeyboardAssign.WINDOW_PRESS_WIDTH,
			Scene.KeyboardAssign.WINDOW_PRESS_HEIGHT,
			{
