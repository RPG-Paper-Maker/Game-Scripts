...
class WindowBox extends Bitmap {
	...
	public static readonly VERY_SMALL_PADDING_BOX = [8, 8, 8, 8];
	public static readonly SMALL_PADDING_BOX = [15, 15, 15, 15];
	public static readonly MEDIUM_PADDING_BOX = [30, 30, 30, 30];
	public static readonly HUGE_PADDING_BOX = [45, 45, 45, 45];
	public static readonly DIALOG_PADDING_BOX = [45, 75, 45, 75];
	public static readonly SMALL_SLOT_PADDING = [15, 8, 15, 8];
	public static readonly SMALL_SLOT_HEIGHT = 45;
	public static readonly LARGE_SLOT_WIDTH = 500;
	public static readonly MEDIUM_SLOT_WIDTH = 400;
	public static readonly SMALL_SLOT_WIDTH = 200;
	public static readonly MEDIUM_SLOT_HEIGHT = 60;
	public static readonly LARGE_SLOT_HEIGHT = 90;
