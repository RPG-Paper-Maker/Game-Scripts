...
export class Platform {
    ...
    static canvasHUD = <HTMLCanvasElement> document.getElementById('hud');
    static canvasVideos = <HTMLCanvasElement> document.getElementById('video-container');
    static canvasRendering = <HTMLCanvasElement> document.getElementById('rendering');
