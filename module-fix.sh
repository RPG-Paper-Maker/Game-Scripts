...
find ./Content/Datas/Scripts/System \( -type d -name .git -prune \) -o -type f -print0 | xargs -0 sed -i -E 's/import (\{ .+ \}|\* as .+) from "(\.\.?\/)^(Manager|Core|Scene|Common|Graphic)"/import \1 from "\2\3\.js"/g'
find ./Content/Datas/Scripts/System \( -type d -name .git -prune \) -o -type f -print0 | xargs -0 sed -i -E 's/import (\{ .+ \}|\* as .+) from "(\.\.?\/)(Manager|Core|Scene|Common|Graphic)"/import \1 from "\2\3\/index\.js"/g'
