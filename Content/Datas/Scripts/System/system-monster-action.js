...
SystemMonsterAction.prototype.read = function(json)
{
    ...
    this.targetKind = RPM.defaultValue(json.tk, MonsterActionTargetKind.Random);
    this.isConditionTurn = RPM.defaultValue(json.ict, false);
    if (this.isConditionTurn)
    {
        this.operationKindTurn = RPM.defaultValue(json.okt, OperationKind.EqualTo);
    ...
    if (this.isConditionStatistic)
    {
        ...
        this.operationKindStatistic = RPM.defaultValue(json.oks, OperationKind
            .EqualTo);
    ...
    if (this.isConditionVariable)
    {
        ...
        this.operationKindVariable = RPM.defaultValue(json.okv, OperationKind
            .EqualTo);
