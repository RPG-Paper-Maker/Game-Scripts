    ...
    update(currentState, object, state) {
        if (!currentState.started) {
            ...
            switch (this.valueKind) {
                case 0: // Number
                    ...
                    break;
                case 1: // Random number
                    currentState.value = RPM.random(this.valueRandomA.getValue(), this.valueRandomB.getValue());
                    break;
                case 2: // Message
                ...
                case 4: // Map object characteristic
                    ...
                    MapObject.updateObjectWithID(object, objectID, this, function (obj) {
        ...
        if (!RPM.isUndefined(currentState.value)) {
            for (let i = 0, l = this.nbSelection; i < l; i++) {
                RPM.game.variables[this.selection + i] = RPM.operators_numbers[this.operation](RPM.game.variables[this.selection + i], currentState.value);
            }
        }
