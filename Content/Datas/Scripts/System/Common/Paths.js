...
Paths.FILE_PICTURES_DATAS = Paths.DATAS + "pictures.json";
Paths.FILE_VIDEOS_DATAS = Paths.DATAS + "videos.json";
Paths.FILE_SONGS_DATAS = Paths.DATAS + "songs.json";
Paths.FILE_SHAPES_DATAS = Paths.DATAS + "shapes.json";
...
Paths.FILE_TILESETS_DATAS = Paths.DATAS + "tilesets.json";
